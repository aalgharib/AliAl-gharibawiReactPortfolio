...
export const HERO_CONTENT = `I specialize in developing AI-powered web applications with expertise in WordPress, Joomla, React, Next.js, and Node.js.`;
...
// export const ABOUT_TEXT = `I am a dedicated and versatile software developer with a focus on full-stack development and experience in SQL and Oracle databases. With 2 years of professional experience, I have developed and maintained web applications using JavaScript, React, Next.js, and Node.js. My background includes troubleshooting and optimizing software solutions, and I am skilled in integrating systems and handling customizations. I thrive in collaborative settings, enjoy solving complex problems, and am committed to delivering high-quality, reliable solutions. Outside of work, I stay active, explore new technologies, and contribute to open-source projects.`;
